...
class Subscription(Base):
    ...
    provider: Mapped[str] = mapped_column(String(20), default="manual", index=True)
    comprovativo_url: Mapped[str | None] = mapped_column(String(500), nullable=True)
    comprovativo_hash: Mapped[str | None] = mapped_column(String(128), nullable=True, index=True)
    ...
    __table_args__ = (
        ...
        Index("ix_sub_hash", "comprovativo_hash"),
    )
