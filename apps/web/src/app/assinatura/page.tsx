...
const PRECOS_TESTE: any = {
    ...
    premium: 2,
    diamond: 3,
    // fallback pelos valores antigos
    '5000': 1,
    '8500': 2,
    '18000': 3
}
    ...
    return (
        <div className="min-h-screen bg-white relative">
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-8 py-6">
                ...
                <p className="text-center text-[10px] tracking-[0.2em] text-gray-400 uppercase mt-1">MODO TESTE - Assinatura mensal / Cancele quando quiser</p>
            </div>
