...
export default function ModalConfirmEmit({
    open,
    tipoDoc,
    total,
    qtdItens,
            ...
            <div className="relative bg-white rounded-[24px] w-full max-w-[400px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
                ...
                <div className="px-6 pt-5 pb-6">
                    ...
                    <div className="flex gap-3 mt-8">
                        ...
                        <button onClick={onConfirm} disabled={loading} className="flex-1 h-11 rounded-full bg-[#0095ff] text-white text-[14px] font-semibold hover:bg-[#0085e6] shadow-[0_6px_20px_rgba(0,149,255,0.35)] flex items-center justify-center gap-2 disabled:opacity-50">
                            {loading? 'Emitindo...' : <><FileCheck className="w-4 h-4" /> Confirmar</>}
                        </button>
                    </div>
                </div>
            </div>
