        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-[24px] w-full max-w-[400px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
                ...
                <div className="px-6 pt-5 pb-6">
                    ...
                    <p className="text-[13.5px] text-gray-500 mt-3 leading-relaxed">{isFatura? 'Vai gerar Hash AGT + QR automático e não poderá ser editada. FT conta no limite do plano.' : 'Proforma sem valor fiscal. Poderá converter em FT depois. PP é sempre livre.'}</p>
                    <div className="mt-4 bg-gray-50 border border-gray-100 rounded-[16px] p-3 text-[12px] space-y-1.5">
                        ...
                        <div className="flex justify-between"><span className="text-gray-500">Tipo</span><span className="font-bold text-gray-900">{isFatura? 'FT - Fatura Oficial (conta no limite)' : 'PP - Proforma (livre)'}</span></div>
                    </div>
