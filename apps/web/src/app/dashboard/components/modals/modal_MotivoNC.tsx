        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-[24px] w-full max-w-[420px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
                ...
                <div className="px-6 pt-5 pb-6">
                    ...
                    <p className="text-[13.5px] text-gray-500 mt-2 leading-relaxed">Vai anular a <span className="font-bold text-gray-900">{faturaNumero}</span>. Escolhe o motivo AGT obrigatório. NC não conta no limite.</p>
