...
const LS_KEYS = { view: 'dashboard_homeView', ftab: 'dashboard_faturaTab', list: 'dashboard_listView' }
...
export default function DashboardPage() {
    ...
    const isInitialLoading =!empresa // CORRIGIDO
    ...
    const fetchFaturasGeral = useCallback(async () => {
        try {
            ...
            setFaturasCurso(all.filter((f: any) => f.tipo_documento === 'proforma')) // CORRIGIDO: faltava um )
