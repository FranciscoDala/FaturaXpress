    ...
    `).join('')
      ...
      <div style="width:210mm;min-height:297mm;padding:10mm;font-family:'Zalando Sans Expanded',sans-serif;font-size:12px;color:black;background:white;position:relative;box-sizing:border-box;overflow:hidden">
        ...
        <div style="position:relative;z-index:1;display:flex;flex-direction:column;min-height:277mm">
          ...
          <table style="width:100%;border-collapse:collapse;margin-top:8px;table-layout:auto;"><colgroup><col style="width:18%"><col style="width:28%"><col style="width:7%"><col style="width:6%"><col style="width:13%"><col style="width:10%"><col style="width:6%"><col style="width:12%"></colgroup><thead><tr style="background:#c2c2c2;font-size:10px;font-weight:700"><th style="border:1px solid #999;padding:6px 4px;text-align:left;background:rgba(194,194,194,0.777)">REFERÊNCIA</th><th style="border:1px solid #999;padding:6px 4px;text-align:left;background:rgba(194,194,194,0.777)">PRODUTO / SERVIÇO</th><th style="border:1px solid #999;padding:6px;background:rgba(194,194,194,0.777)">QTD.</th><th style="border:1px solid #999;padding:6px;background:rgba(194,194,194,0.777)">UN.</th><th style="border:1px solid #999;padding:6px;background:rgba(194,194,194,0.777)">PREÇO UNIT.</th><th style="border:1px solid #999;padding:6px;background:rgba(194,194,194,0.777)">DESCONTO</th><th style="border:1px solid #999;padding:6px;background:rgba(194,194,194,0.777)">TAXA</th><th style="border:1px solid #999;padding:6px;text-align:right;background:rgba(194,194,194,0.777)">VALOR (AKZ)</th></tr></thead><tbody>${itensRows}${emptyRows}</tbody></table>
          <div style="display:flex;margin-top:8px;gap:4px;">
            <div style="flex:1;border:1px solid #999;"><div style="display:flex;background:rgba(194,194,194,0.777);font-size:10px;font-weight:700"><div style="flex:1;border-right:1px solid #999;padding:6px 4px;background:rgba(194,194,194,0.777)">IMPOSTO</div><div style="width:50px;border-right:1px solid #999;padding:6px;text-align:center;background:rgba(194,194,194,0.777)">TAXA</div><div style="width:80px;border-right:1px solid #999;padding:6px;text-align:center;background:rgba(194,194,194,0.777)">INCIDÊNCIA</div><div style="width:80px;padding:6px;text-align:center;background:rgba(194,194,194,0.777)">VALOR</div></div>${ivaRows}</div>
            <div style="width:240px;">
              <div style="display:flex;background:rgba(194,194,194,0.777);font-size:10px;border:1px solid #999"><div style="flex:1;padding:6px 4px;text-align:right;background:rgba(194,194,194,0.777)">Total Líquido</div><div style="width:90px;background:rgba(255,255,255,0.55);border-left:1px solid #999;padding:6px;text-align:right">${fmt(totais.liquido)}</div></div>
              <div style="display:flex;background:rgba(194,194,194,0.777);font-size:10px;border:1px solid #999;border-top:0"><div style="flex:1;padding:6px 4px;text-align:right;background:rgba(194,194,194,0.777)">Total Desconto</div><div style="width:90px;background:rgba(255,255,255,0.55);border-left:1px solid #999;padding:6px;text-align:right">${fmt(totais.desconto)}</div></div>
              <div style="display:flex;background:rgba(194,194,194,0.777);font-size:10px;border:1px solid #999;border-top:0"><div style="flex:1;padding:6px 4px;text-align:right;background:rgba(194,194,194,0.777)">Total IVA</div><div style="width:90px;background:rgba(255,255,255,0.55);border-left:1px solid #999;padding:6px;text-align:right">${fmt(totais.iva)}</div></div>
            ...
            <div className="relative z-10 flex flex-col flex-1">
                ...
                <div className="flex mt-2 gap-1">
                    <div className="flex-1 border border-[#999]">
                        <div className="flex bg-[rgba(194,194,194,0.777)] text-[10px] font-bold"><div className="flex-1 border-r border-[#999] py-[5px] px-1">IMPOSTO</div><div className="w-[50px] border-r border-[#999] py-[5px] text-center">TAXA</div><div className="w-[80px] border-r border-[#999] py-[5px] text-center">INCIDÊNCIA</div><div className="w-[80px] py-[5px] text-center">VALOR</div></div>
                    ...
                    <div className="w-[240px] shrink-0">
                        <div className="flex bg-[rgba(194,194,194,0.777)] text-[10px] border border-[#999]"><div className="flex-1 py-[6px] px-1 text-right">Total Líquido</div><div className="w-[90px] bg-[rgba(255,255,255,0.55)] border-l border-[#999] py-[6px] text-right pr-1">{fmt(totais.liquido)}</div></div>
                        <div className="flex bg-[rgba(194,194,194,0.777)] text-[10px] border border-[#999] border-t-0"><div className="flex-1 py-[6px] px-1 text-right">Total Desconto</div><div className="w-[90px] bg-[rgba(255,255,255,0.55)] border-l border-[#999] py-[6px] text-right pr-1">{fmt(totais.desconto)}</div></div>
                        <div className="flex bg-[rgba(194,194,194,0.777)] text-[10px] border border-[#999] border-t-0"><div className="flex-1 py-[6px] px-1 text-right">Total IVA</div><div className="w-[90px] bg-[rgba(255,255,255,0.55)] border-l border-[#999] py-[6px] text-right pr-1">{fmt(totais.iva)}</div></div>
