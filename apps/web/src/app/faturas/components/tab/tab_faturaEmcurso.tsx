        ...
        <div className="w-full px-4 sm:px-8 lg:px-12 mt-0">
            ...
            {faturas.length === 0? (
                ...
                <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-2 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                    {faturas.map(f => (
                        <div key={f.id} className="min-w-[85%] sm:min-w-[300px] md:max-w-[300px] snap-start flex-shrink-0 bg-white rounded-[22px] overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col">
