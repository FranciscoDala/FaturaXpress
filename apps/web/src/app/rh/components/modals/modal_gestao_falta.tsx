...
import { X, Check, Ban, Trash2, FileText, Upload, Eye, Info, Clock, User, Calendar, Loader2, Lock } from 'lucide-react'
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar px-6 py-4">
            ...
            {tab === 'justificar' && (
              <div className="flex flex-col gap-3">
                <select disabled={!podeJustificar} value={tipo} onChange={e=>setTipo(e.target.value)} className={`${inputClass} disabled:bg-gray-50 disabled:opacity-60`}>
