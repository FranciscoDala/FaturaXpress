                                    ...
                                    <div className={`flex items-center gap-3 w-full px-3 ${isFew ? 'justify-end' : 'justify-center'}`}>
                                        {isFinalizada ? (
                                            ...
                                            <>
                                                ...
                                                {!isAdmin && (
                                                    <button disabled={!!actingId} onClick={() => onActionAtraso(funcionarioId, 'encaminhar')} className="w-11 h-11 rounded-full bg-amber-500 shadow-sm flex items-center justify-center text-white active:scale-90 transition-transform"><Send className="w-[18px] h-[18px]" /></button>
                                                )}
                                                <button disabled={!!actingId} onClick={() => onActionAtraso(funcionarioId, 'aplicar')} className="w-11 h-11 rounded-full bg-orange-500 shadow-sm flex items-center justify-center text-white active:scale-90 transition-transform"><Clock className="w-5 h-5" /></button>
                                            </>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className={`flex items-center gap-3 w-full px-3 ${isFewFalta ? 'justify-end' : 'justify-center'}`}>
                                    ...
                                    {!isFinalizada && (
                                        <>
                                            ...
                                            {!isAdmin && (<button disabled={!!actingId} onClick={() => onAction(n.falta?.id, 'encaminhar')} className="w-11 h-11 rounded-full bg-amber-500 shadow-sm flex items-center justify-center text-white active:scale-90 transition-transform"><Send className="w-[18px] h-[18px]" /></button>)}
