...
export default function RelatorioAuditoriaPonto({ dataSelecionada, pontos, faltas, funcs, empresa, usuario, minDate, hoje, onClose }: Props){
            ...
            <div className="relative z-10 flex flex-col flex-1">
                ...
                <div className="w-full mt-2">
                    <table className="w-full border-collapse table-fixed">
                        <colgroup><col style={{ width: '24%' }} /><col style={{ width: '11%' }} /><col style={{ width: '11%' }} /><col style={{ width: '13%' }} /><col style={{ width: '15%' }} /><col style={{ width: '8%' }} /><col style={{ width: '18%' }} /></colgroup>
                        <thead><tr className="bg-[rgba(194,194,194,0.65)] text-[11px] font-bold"><th className="border border-[#999] py-[7px] px-1 text-left">FUNCIONARIO</th><th className="border border-[#999] py-[7px]">ENTRADA</th><th className="border border-[#999] py-[7px]">SAIDA</th><th className="border border-[#999] py-[7px]">STATUS</th><th className="border border-[#999] py-[7px] text-left">MOTIVO</th><th className="border border-[#999] py-[7px]">RETRO?</th><th className="border border-[#999] py-[7px] px-1 text-left text-[10px]">RESPONSAVEL</th></tr></thead>
                        <tbody>
                            {linhas.map((l,i)=>(<tr key={i} className="text-[11px] h-[28px]"><td className="border border-[#bbb] px-1 bg-[rgba(255,255,255,0.40)] truncate font-bold">{l.nome}</td><td className="border border-[#bbb] text-center bg-[rgba(255,255,255,0.40)]">{l.entrada}</td><td className="border border-[#bbb] text-center bg-[rgba(255,255,255,0.40)]">{l.saida}</td><td className="border border-[#bbb] text-center bg-[rgba(255,255,255,0.40)] truncate">{l.status}</td><td className="border border-[#bbb] px-1 bg-[rgba(255,255,255,0.40)] truncate">{l.motivo}</td><td className="border border-[#bbb] text-center bg-[rgba(255,255,255,0.40)]">{l.retro}</td><td className="border border-[#bbb] px-1 bg-[rgba(255,255,255,0.40)] truncate" title={l.responsavel}>{l.responsavel}</td></tr>))}
    ...
    return (
        <div className="fixed inset-0 z-[10000] bg-[#525659] flex flex-col overflow-hidden">
            <style>{`
              #relatorio-pdf-wrapper{flex:1;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;display:flex;justify-content:center;width:100%;background:transparent}
