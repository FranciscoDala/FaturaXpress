...
import { exportPontoPDF } from '../../../../lib/export_pdf_ponto'
                ...
                <div className="p-3 border-b bg-gray-50 flex flex-col gap-2">
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2 w-full">
                            ...
                            <button onClick={()=>exportPontoPDF(dataSelecionada, pontos, faltas, funcs, minDate, hoje)} className="hidden md:flex h-8 px-3 rounded-full bg-black text-white text-[11px] font-bold items-center gap-1 hover:bg-black/90 shrink-0"><Download className="w-3.5 h-3.5"/> PDF Único</button>
                        ...
                        <div className="flex items-center gap-2 w-full">
                            ...
                            <button onClick={()=>exportPontoPDF(dataSelecionada, pontos, faltas, funcs, minDate, hoje)} className="flex md:hidden w-10 h-10 rounded-full bg-black text-white items-center justify-center shadow-sm shrink-0"><Download className="w-4 h-4"/></button>
